...
export default function AttendanceForm({ mode, attendance, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      } else if (mode === 'edit' && attendance?.id) {
        await updateDoc(doc(db, 'attendance', attendance.id), formData);
      }
      onSuccess();
    } catch (err) {
